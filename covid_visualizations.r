...
# Reading in datasets/confirmed_cases_china_vs_world.csv
...
# line plot of cumulative cases vs. date, grouped and colored by is_china
...
# Changing the plot to use a logarithmic scale on the y-axis
plt_not_china_trend_lin + 
  scale_y_log10()
...
# Using Group by country, summarize to calculate total cases, and the top 7
...
# Using confirmed_cases_top7_outside_china, to draw a line plot 
